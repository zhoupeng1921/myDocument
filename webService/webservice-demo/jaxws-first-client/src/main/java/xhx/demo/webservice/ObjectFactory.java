 ...
 * generated in the xhx.demo.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://webservice.demo.xhx/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://webservice.demo.xhx/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: xhx.demo.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.demo.xhx/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.demo.xhx/", name = "queryWeather")
